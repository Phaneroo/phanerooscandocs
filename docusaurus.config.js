...
const config = {
  ...
  url: 'https://phaneroo.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/phanerooscandocs/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'Phaneroo', // Usually your GitHub org/user name.
  projectName: 'phanerooscandocs', // Usually your repo name.
  trailingSlash: false,
